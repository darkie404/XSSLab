/* XSSLab - Main Application JavaScript - Updated 2025-12-31 */
  ...
  */
  ...
  displayFallbackContributors(leaderboard) {
    const fallbackContributors = [
      { name: 'Amit Verma', username: 'darkie404', payloads: 25, avatar: 'S' },
      { name: 'Nexus', username: 'xss0r', payloads: 18, avatar: 'S' }
    ];
