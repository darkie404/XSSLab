/* XSSLab - Contributors Management System */
...
class ContributorsManager {
    ...
    createFallbackData() {
        ...
        return {
            payloads: [
                {
                    contributor: "Amit Verma",
                    github_username: "darkie404",
                    country: "India",
                    category: "basic",
    ...
    getBio(username) {
        const bioMap = {
            'darkie404': 'XSSLab creator and cybersecurity researcher',
    ...
    getBadges(username) {
        const badgeMap = {
            'darkie404': ['contributor', 'researcher', 'expert', 'ninja', 'legend', 'founder'],
