...
class SEOFramework {
    ...
    optimizeMetadata() {
        ...
        this.setMetaTag('author', 'XSSLab Security Research Team');
        ...
        this.setMetaProperty('og:site_name', 'XSSLab - XSS Security Research Platform');
        ...
        this.setMetaName('twitter:site', '@XSSLab');
        ...
        // Additional SEO tags
        this.setMetaName('application-name', 'XSSLab');
    ...
    generateMetadata() {
        const metadataMap = {
            home: {
                title: 'XSSLab - Ultimate XSS Payload Arsenal & Security Research Platform',
            ...
            contributors: {
                ...
                description: 'Meet the security researchers, bug bounty hunters, and contributors who make XSSLab possible. Join our community of ethical hackers.',
                keywords: this.keywords
            }
        };
        ...
        const baseStructuredData = {
            ...
            "@graph": [
                ...
                },
                {
                    ...
                    "name": "XSSLab Security Research",
                    "url": this.baseUrl,
                    "logo": {
                        "@type": "ImageObject",
                        "url": `${this.baseUrl}/assets/fav.svg`
                    },
                    "sameAs": [
                        "https://github.com/darkie404/XSSLab",
                        "https://twitter.com/darkie404"
                    ]
                }
            ]
        };
    ...
    getPageSpecificStructuredData() {
        const pageDataMap = {
            documentation: {
                ...
                "author": {
                    "@type": "Organization",
                    "name": "XSSLab Security Research Team"
                },
