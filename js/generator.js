/* XSSLab - Professional XSS Payload Generator */

class XSSPayloadGenerator {
  constructor() {
    this.payloadDatabase = [];
    this.history = JSON.parse(localStorage.getItem('XSSLab-history') || '[]');
  ...
  savePayloadItem(index) {
    ...
    localStorage.setItem('XSSLab-history', JSON.stringify(this.history));
    this.renderHistory();
  ...
  exportPayloads() {
    ...
    const filename = `XSSLab-payloads-${timestamp}.txt`;
